...
if( isset($_POST["submit"]) ) {
	...
	// Untuk nambah database class-2
	if( tambahTaskClass3($_POST) > 0 ) {
		echo "
			<script>
  ...
  $siswa = $siswa = query("SELECT * FROM `student` WHERE `class` = 'Class 3'");
  foreach($siswa as $row) :
    $_SESSION["iniusername"] = $row["username"];
    if( tambahTaskStudentClass3($_POST) > 0 ) {
      echo "
        <script>
          document.location.href = 'teacher-class3.php';
        </script>
...
//Select
$data = query("SELECT * FROM `class-3`");
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4"><i class="bi bi-columns-gap me-3"></i>Class 3</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Manage your class 3!</li>
                        </ol>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-3 col-md-6 mb-2">
                                <div class="card mb-3 bg-primary">
                                    ...
                                    <center>
                                        <a href="teacher-edit2.php?id=<?= $row["id"];?>" class="btn text-black me-2" style="background-color:#dee094">
                                           <i class="fas fa-pencil-alt me-2"></i><span>Edit</span>
                                        </a>
                                        <a href="function/hapusTaskClass3.php?id=<?= $row["id"];?>" class="btn text-black" style="background-color:#fe5757"
