                                      ...
                                      <?php $x = 0; ?>
                                        ...
                                        <?php endif; ?>
                                            ...
                                            <li class="list-group-item py-2 pe-1 d-flex align-items-center flex-grow-2 border-0 bg-transparent">
                                              <a href="function/hapusGuestTDL.php?id=<?= $row["id"];?>" class="btn bg-danger p-2 text-white"
