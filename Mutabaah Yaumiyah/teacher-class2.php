...
if( isset($_POST["submit"]) ) {
  ...
  $siswa = $siswa = query("SELECT * FROM `student` WHERE `class` = 'Class 2'");
  foreach($siswa as $row) :
    $_SESSION["iniusername"] = $row["username"];
    if( tambahTaskStudentClass2($_POST) > 0 ) {
      echo "
        <script>
          document.location.href = 'teacher-class2.php';
        </script>
...
//Select
$data = query("SELECT * FROM `class-2`");
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4"><i class="bi bi-columns-gap me-3"></i>Class 2</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Manage your class 2!</li>
                        </ol>
                            ...
                            <div class="col-xl-3 col-md-6 mb-2">
                                <div class="card mb-3 bg-primary">
                                    ...
                                    <center>
                                        ...
                                        <a href="function/hapusTaskClass2.php?id=<?= $row["id"];?>" class="btn text-black" style="background-color:#fe5757"
