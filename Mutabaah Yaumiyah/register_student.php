    ...
    <div class="row py-5 mt-4 align-items-center">
        ...
        <div class="col-md-3 col-lg-6 pr-lg-5 mb-5 mb-md-0">
            <div class="pb-5 pr-5 mb-5">
                <center>
                <i class="bi bi-person-rolodex" style="font-size: 300px; color: #008080;"></i></center>
            </div>
        </div>
            ...
            <form action="#" method="POST">
                <div class="row">
                    ...
                    <div class="input-group col-lg-12 mb-4">
                        ...
                        <input id="student" name="student" placeholder="Student ID" class="form-control bg-white border-left-0 border-md">
                    </div>
                    ...
                    <div class="input-group col-lg-12 mb-4">
                        ...
                        <input id="App" name="App" placeholder="App ID" class="form-control bg-white border-md border-left-0">
                    </div>
                    ...
                    <div class="form-group col-lg-12 mx-auto mb-0">
                        <button class="btn btn-primary btn-block py-2 font-weight-bold" type="submit" name="register" style="background-color:   #008080;">Register</button>
                    </div>
